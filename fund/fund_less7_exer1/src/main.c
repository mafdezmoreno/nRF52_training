...
void thread0(void)
{
    while (1)
    {
        ...
        // k_yield(); //! From “Running” to “Runnable”
        /* STEP 10 - Put the thread to sleep */
        k_msleep(50); //! From “Running” to “Non-runnable”
        /*  When sleeping, threads are put in the “Non-runnable” state and do very little processing */
...
void thread1(void)
{
    while (1)
    {
        ...
        // k_yield();
        /* STEP 10 - Put the thread to sleep */
        k_msleep(50); /*  When sleeping, threads are put in the “Non-runnable” state and do very little processing */
