...
K_SEM_DEFINE(instance_monitor_sem, 10, 10); //! Semaphore definition
...
void get_access(void)
{
    ...
    k_sem_take(&instance_monitor_sem, K_FOREVER); //! Take semaphore
...
void release_access(void)
{
    ...
    k_sem_give(&instance_monitor_sem); //! Release semaphore
}
